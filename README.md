...
| **Docker Proxy 同步** | 解析 Docker/OCI Manifest 后按依赖同步 Blob，支持多架构镜像同步，Docker 与通用 Sync 流程分离，支持全量/指定 Tag，Registry V2 API 错误处理+重试，远程优先路径探测（自动判断目录/Tag），远程无 Tag 时任务报错 |
